...
SENSOR_POSITIONS_X_Y_Z = {
    ...
    "dps310_2": np.array([0.7145, -0.172, -0.002]),
    "dps310_3": np.array([0.7145, -0.172, -0.058]),
    "dps310_4": np.array([-0.028, 0.5625, -0.002]),
    "dps310_5": np.array([-0.028, 0.5625, -0.058]),
    "dps310_6": np.array([-0.056, -0.172, 0.7125]),
    "dps310_7": np.array([0.0, -0.172, 0.7125]),
